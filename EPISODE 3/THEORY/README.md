...
Q: Rules of JSX
A: 1. Return a single root element - To return multiple elements from a component, wrap them with a single parent tag. For instance, We can use
...
module: When we specify type="module", the script is treated as an ECMAScript module. This value tells the browser that the script is a module that can import or export other files or modules inside it. Example:

<script type="module">
    // JavaScript module code here
</script>
text/babel: This value indicates that the script is a babel type and requires the Babel JavaScript compiler to transpile JSX code. text/typescript: The script is written in TypeScript.

Q: {TitleComponent} vs {<TitleComponent/>} vs {<TitleComponent></TitleComponent>} in JSX
A: {TitleComponent} - This expression is used when we want to embed a component as a javascript expression or a variable. Example:
...
{<TitleComponent/>} - This expression creates and renders an instance of the TitleComponent component. It's the most common way to use a component in JSX when we want to render the component as part of your UI. Most commonly, you will use {} to create and render a component.
...
{<TitleComponent></TitleComponent>} - This is essentially the same as {<TitleComponent/>} in most cases. Both create and render an instance of the TitleComponent component. The explicit use of opening and closing tags might be used in situations where we want to include child elements within the TitleComponent. Example:
